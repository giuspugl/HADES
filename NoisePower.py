...
def lensed_Cl(delensing_fraction=a.delensing_fraction,ffp10_spectrum=a.ffp10_spectrum):
	...
	"""
	if ffp10_spectrum:
		from .lens_power import ffp10_lensing # instead return fit to FFP10 lensing spectrum
		return ffp10_lensing(delensing_fraction,camb_spectrum=False)
	# Read in data
