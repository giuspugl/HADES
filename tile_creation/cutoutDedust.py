if __name__=='__main__':
	...
	def mapCreate(i,firstTime=False): 
		...
		if roundMask[centerPixes[i]]==1:
			good_map = True
			#return [good_map,0,0]
			outDir=a.root_dir+'Dedusted/f%s_ms%s_s%s_fw%s_np%s_d%s/' %(a.freq,a.map_size,a.sep,a.FWHM,a.noise_power,a.delensing_fraction)
			...
			mapsU.loadDataFromHealpixMap(healpixMapU)
				...
				output=compute_angle(i,padding_ratio=a.padding_ratio,map_size=a.map_size,sep=a.sep,freq=a.freq,\
