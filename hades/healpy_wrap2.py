...
if __name__=='__main__':
	...
	outDir=a.root_dir+'FullMapsBatchData/f%s_ms%s_s%s_fw%s_np%s_d%s/' %(a.freq,a.map_size,a.sep,a.FWHM,a.noise_power,a.delensing_fraction)
...
def wrapper(map_id,map_size=a.map_size,\
	...
	from .healpy_tools import MakeCombinedFourierMaps
	from .PaddedPower import DegradeFourier,DegradeMap
	fBdust,padded_window,unpadded_window=MakeCombinedFourierMaps(map_id,padding_ratio=padding_ratio,map_size=map_size,sep=sep,freq=freq,\
				fourier=True,power=False,returnMasks=True,flipU=flipU,dust_dir='/data/ohep2/CleanWidePatch/',root_dir=root_dir,\
				delensing_fraction=delensing_fraction,f_noise=1.,f_dust=f_dust,FWHM=FWHM,noise_power=noise_power,healpy_flipU=True)
	unpadded_fBdust=MakeCombinedFourierMaps(map_id,padding_ratio=1.,map_size=map_size,sep=sep,freq=freq,\
				fourier=True,power=False,returnMasks=False,flipU=flipU,dust_dir='/data/ohep2/CleanWidePatch/',root_dir=root_dir,\
				delensing_fraction=delensing_fraction,f_noise=1.,f_dust=f_dust,FWHM=FWHM,noise_power=noise_power,healpy_flipU=True)
	...
	Cl_lens_func=ffp10_lensing(delensing_fraction,camb_spectrum)
