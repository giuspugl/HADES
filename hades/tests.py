...
def padded_wrap(map_id,map_size=a.map_size,\
	...
	#ll=np.arange(5,3000)
	#pp=1.0e-11*ll**(-2.42)
	#fBdust=padded_fill_from_Cell(padded_window.copy(),ll,pp,lMin=lMin)#,padding_ratio=padding_ratio)
	#unpadded_fBdust=padded_fill_from_Cell(unpadded_window.copy(),ll,pp,lMin=lMin)#,padding_ratio=padding_ratio)
