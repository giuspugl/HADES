...
if __name__=='__main__':
	...
	outDir=a.root_dir+'DebiasedBatchData/f%s_ms%s_s%s_fw%s_np%s_d%s/' %(a.freq,a.map_size,a.sep,a.FWHM,a.noise_power,a.delensing_fraction)
	...
	output=tile_wrap(map_id) # debiased_wrap(map_id) estimator_wrap(map_id)
...
def tile_wrap(map_id,map_size=a.map_size,\
	...
	#powMC=fftTools.powerFromFFT(fBias.copy())
	#return l_cen,mean_pow,powMC		
