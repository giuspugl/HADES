...
def lensed_wrap(map_id,map_size=a.map_size,\
    ...
    from .lens_power import MakeFourierLens
    fourier_lens=MakeFourierLens(map_id,padding_ratio=padding_ratio,map_size=map_size,sep=sep,\
            fourier=True,power=False,flipU=True,delensing_fraction=delensing_fraction,\
            lMax=lCut,l_step=l_step)
    unpadded_lens=MakeFourierLens(map_id,padding_ratio=1.,map_size=map_size,sep=sep,\
            fourier=True,power=False,flipU=True,delensing_fraction=delensing_fraction,\
            lMax=lCut,l_step=l_step*padding_ratio)
