...
def patch_hexadecapole(map_size=a.map_size,sep=a.sep,FWHM=a.FWHM,noise_power=a.noise_power,\
            ...
            root_dir=a.root_dir,I2SNR=a.I2SNR,returnAll=False,plot=True,monopole=False,display=True):
    ...
    if returnAll:
        ...
        if monopole:
            ...
            if display:
                print('The significance of a detection of dust anisotropy in this region is %.2f sigma' %(sigmas))
                return None
            else:
